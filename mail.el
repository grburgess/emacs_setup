...
(with-eval-after-load 'mu4e
  ...
  (setq mu4e-maildir "~/mail"
        ...
        mu4e-user-mail-address-list '("jmichaelburgess@gmail.com" "jburgess@mpe.mpg.de")
  ...
  (setq
   ...
   `(,(make-mu4e-context
       ...
       :match-func (lambda (msg)
		     (when msg
		       (mu4e-message-maildir-matches msg "^/gmail-personal/")
     ...
     ,(make-mu4e-context
       ...
       :vars '((mu4e-sent-folder . "/mpe/sent")
	       (mu4e-trash-folder . "/mpe/Deleted Messages")
